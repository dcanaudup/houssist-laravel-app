<x-slot:header>
    <p class="mt-6 text-center text-2xl font-medium tracking-tight text-gray-900">Create a <span class="text-3xl font-bold">Homeowner</span> Account</p>
    ...
    <div class="mb-6">
        ...
        <div class="relative">
            ...
            <div class="relative flex justify-center text-sm">
                <span class="bg-indigo-50 px-2 text-gray-500">Or</span>
            </div>
        </div>
    </div>
    @endif
