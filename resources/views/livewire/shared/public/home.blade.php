...
<div class="px-6 pt-6 lg:px-8">
    <nav class="flex items-center justify-between" aria-label="Global">
        <div class="flex lg:flex-1 space-x-2">
...
<div class="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:flex lg:items-center lg:gap-x-10 lg:px-8 lg:py-40">
    <div class="mx-auto max-w-2xl lg:mx-0 lg:flex-auto">
        <h1 class="mt-10 max-w-lg text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">Houssist: Hire help for household tasks</h1>
        <p class="mt-6 text-lg leading-8 text-gray-600">Advertise, negotiate and connect with a plethora of approved service providers for your household needs.</p>
        <div class="mt-10 flex items-center gap-x-6">
            <a href="{{route('home-owner.registration.create')}}" class="rounded-md bg-indigo-600 px-3.5 py-1.5 text-base font-semibold leading-7 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Get started</a>
            <a href="{{route('service-provider.registration.create')}}" class="text-base font-semibold leading-7 text-gray-900">Want to be a Service Provider <span aria-hidden="true">?</span></a>
        </div>
    </div>
